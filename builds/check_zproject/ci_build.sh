...
git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/libcidr.git cidr
git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/cxxtools.git cxxtools
git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/nut.git libnutclient
cd -
