...
/// converts status from uint16_t bitmap (e.g. STATUS_CHRG|STATUS_OL) to text representation (e.g. "OL CHRG")
std::string upsstatus_to_string(uint16_t status);

/// converts status from std::string bitmap (e.g. "12") to text representation (e.g. "OL CHRG")
