...
alert_actor_test (bool verbose)
{
...

    {
        ...
        std::string rule_template = "{ \"threshold\" : { \"name\" : \"__name__\", \"source\" : \"NUT\", \"class\" : "
            ...
            "], \"description\" : \"__description__\", \"metrics\" : \"__metrics__\", \"assets\" : \"__assets__\", "
            "\"values_unit\" : \"__values_unit__\", \"values\" : [ { \"low_warning\" : \"__low_warning__\" }, { "
            "\"low_critical\" : \"__low_critical__\" }, { \"high_warning\" : \"__high_warning__\" }, { "
            "\"high_critical\" : \"__high_critical__\" } ], \"results\" : [ { \"low_critical\" : { \"action\" : [ { "
            "\"action\" : \"EMAIL\" }, { \"action\" : \"SMS\" } ], \"severity\" : \"CRITICAL\", \"description\" : { "
            "\"key\" : \"{{alert_name}} is critically low for {{ename}}.\", \"variables\" : { \"alert_name\" : "
            "\"__alert_name__\", \"ename\" : { \"value\" : \"__ename__\", \"assetLink\" : \"__name__\" } } } } }, { "
            "\"low_warning\" : { \"action\" : [ { \"action\" : \"EMAIL\" }, { \"action\": \"SMS\" } ], \"severity\" : "
            "\"WARNING\", \"description\" : { \"key\" : \"{{alert_name}} is low for {{ename}}.\", \"variables\" : { "
            "\"alert_name\" : \"__alert_name__\", \"ename\" : { \"value\" : \"__ename__\", \"assetLink\" : \"__name__\""
            " } } } } }, { \"high_warning\" : { \"action\" : [ { \"action\": \"EMAIL\" }, { \"action\": \"SMS\" } ], "
            "\"severity\" : \"WARNING\", \"description\" : { \"key\" : \"{{alert_name}} is high for {{ename}}.\", "
            "\"variables\" : { \"alert_name\" : \"__alert_name__\", \"ename\" : { \"value\" : \"__ename__\", "
            "\"assetLink\" : \"__name__\" } } } } }, { \"high_critical\" : { \"action\" : [ { \"action\": \"EMAIL\" }, "
            "{ \"action\": \"SMS\" } ], \"severity\" : \"CRITICAL\", \"description\" : { \"key\" : \"{{alert_name}} "
            "is critically high for {{ename}}.\", \"variables\" : { \"alert_name\" : \"__alert_name__\", \"ename\" : { "
            "\"value\" : \"__ename__\", \"assetLink\" : \"__name__\" } } } } } ], \"evaluation\" : \"function main (v1)"
            " if tonumber (v1) <= tonumber (low_critical) then return 'low_critical'; elseif tonumber (v1) <= tonumber "
