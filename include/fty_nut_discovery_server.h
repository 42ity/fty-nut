...
fty_nut_discovery_server_t * fty_nut_discovery_server_new (void);

//  Destroy the fty_nut_discovery_server
void fty_nut_discovery_server_destroy (fty_nut_discovery_server_t **self_p);

//  ftydiscovery actor
void fty_nut_discovery_server (zsock_t *pipe, void *args);

//  Self test of this class
void fty_nut_discovery_server_test (bool verbose);
//  @end
